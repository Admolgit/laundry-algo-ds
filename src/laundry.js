 ...
 */
  ...
  function getMaxPairs(noOfWashes, cleanPile, dirtyPile) {
    ...
    for(let i = 0; i < dirtyPile.length; i++) {
      // Check if the number of washes is greater than the socks washed counted and clean pile includes a sock that can pair a  sock in the dirty pile and if there is any sock remaining
